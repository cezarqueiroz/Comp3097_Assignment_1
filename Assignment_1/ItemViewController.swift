...
//  Assignment_1
//
//  Created by jhsdj on 2025-03-07.
//
...
class ItemViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    var listItems = ["Item 1", "Item 2", "Item 3", "Item 4", "Item 5", "Item 6", "Item 7", "Item 8", "Item 9", "Item 10", "Item 11"]
    ...
    override func viewDidLoad() {
        ...
        titleLabel = UILabel()
        titleLabel.text = selectedListItem
